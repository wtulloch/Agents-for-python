...
from microsoft.agents.core.models import (
    AttachmentInfo, ConversationResourceResponse, ConversationsResult, ConversationParameters, ResourceResponse, Activity, 
...
class ConversationsBase(Protocol):
    ...
    @abstractmethod
    async def create_conversation(self, parameters: ConversationParameters) -> ConversationResourceResponse:
        """
    ...
    @abstractmethod
    async def get_conversation_member(self, conversation_id: str, user_id: str) -> ChannelAccount:
        """
        Enumerate the members of a conversation.
        """
        raise NotImplementedError()
    ...
    @abstractmethod
    async def get_conversation_paged_members(self, conversation_id: str, page_size: Optional[int] = None, continuation_token: Optional[str] = None) -> PagedMembersResult:
        """
